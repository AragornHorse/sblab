...
def train():
    ...
    try:
        # Create environment
        env_args = {
            'log_saving_path': f'./log/pdi_logs/PPO_dssat_pdi.log',
            'mode': 'fertilization',
            # 'mode': 'irrigation',
            'seed': 123,
            'random_weather': True,
        ...
        directory = "./output/PPO"
        os.makedirs(directory, exist_ok=True)



        checkpoint_path = os.path.join(directory,f"PPO_{random_seed}_{run_num_pretrained}.pth")
        ...
        ppo_agent = PPO_agent(state_dim, action_dim, lr_actor, lr_critic, gamma, K_epochs, eps_clip, has_continuous_action_space, action_std)
